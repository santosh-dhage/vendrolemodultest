    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priority', models.CharField(blank=True, default='Low', max_length=20, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='contactus',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership_type', models.CharField(choices=[('Enterprise', 'Enterprise'), ('Standard', 'Standard'), ('Basic', 'Basic'), ('Free', 'Free')], default='Free', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mobile_no', models.CharField(blank=True, max_length=15, null=True)),
                ('feedback', models.CharField(blank=True, max_length=500, null=True)),
                ('feacture_request', models.CharField(blank=True, max_length=50, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('created_by', models.IntegerField(blank=True, null=True)),
                ('updated_by', models.IntegerField(blank=True, null=True)),
                ('updated_at', models.DateTimeField(blank=True, null=True)),
