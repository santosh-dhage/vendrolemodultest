...
function Topic() {
  ...
  let getTopic = async () => {
    let response = await api.get('/machine/get_product_list/')
  ...
  const saveTopic = async (e) => {
    ...
    if (form.checkValidity() === true) {  
          ...
          let response = await api.post('/machine/product/', uploadData);
  ...
  const updateTopic = async (e) => {
    ...
    //   uploadData.append('password', 'Vendsoft@12')
      ...
      let response = await api.patch(`/machine/product/${id}/`, uploadData)
      if (response.data.success === 1) {
  ...
  return (
    <>
      ...
      <h3 className="mb-0" style={{ color: '#2C384A' }}>Product Type</h3>
      <CButton
     ...
     Add New
      ...
      >
        ...
        >
          <CModalTitle>  Add Product Type</CModalTitle>
        </CModalHeader>
        <CForm
      ...
      >
        <CModalHeader
          ...
          style={{ backgroundColor:selectedColor, color: 'white' }}
        >
          <CModalTitle>Edit Product  Details</CModalTitle>
        </CModalHeader>
        <CForm
          className="row g-3 needs-validation"
          style={{ margin: '10px' }}
          ...
          <CModalBody>
            <CRow sm={12} className="">
              <CCol sm={6} >
                ...
                //   pattern="[A-Za-z\s]+"
                  required
                  defaultValue={userdata?.product_type}
                  maxLength={50}
                />
                <CFormFeedback invalid>Please enter  Product Name</CFormFeedback>
              </CCol>
