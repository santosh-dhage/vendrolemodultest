...
function Topic() {
  ...
  let getTopic = async () => {
    let response1 = await api.get('/machine/api/get_unused_machine_map_for_customer/');
    let response3 = await api.get('/machine/api/machine_user_mapping_by_customer/');
  ...
  const saveTopic = async (e) => {
    ...
    if (form.checkValidity() === true) {
      ...
      let response = await api.put(`/machine/machine-user-mapping/${e.target.machine1.value}/`, uploadData);
  ...
  const updateTopic = async (e) => {
    ...
    if (form.checkValidity() === true) {
      ...
      if (response.data.success === 1) {
        ...
        alert('User mapped to Machine ID updated.')
        setValidated(false)
        setVisible2(false)
        getTopic()
      } else if (response.data.success === 0) {
                    ...
                    <Link to="#">
                      <CIcon
                        ...
                        onClick={() => [setUserdata(item), 
                          get_training_data(item), setid(item.id), setVisible2(!visible2)]}
                      />
                    </Link>
                    &nbsp;&nbsp;&nbsp;
            ...
            <CRow sm={12} className="">
              <CRow>
                <CCol sm={6}>
                  ...
                  <CFormSelect name="assigned_user" options={notes3} required />
                ...
                <CCol sm={6}>
                  ...
                  <CFormSelect name="machine1" options={notes} required />
